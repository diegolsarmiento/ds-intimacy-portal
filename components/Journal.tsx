...
const readingMoments: Record<string, string> = {
  'soft-ux-presence': 'Best read slowly, with coffee and quiet.',
  'companions-and-belonging': 'Best read late at night, when questions linger.',
  'language-that-touches': 'Best read aloud—or whispered, if you dare.',
}
...
const posts: Post[] = [
  {
    ...
    excerpt: 'Rituals, consent patterns, and gentle friction that teach interfaces to feel.',
    date: '2025-10-12',
  ...
  },
  {
    ...
    excerpt: 'Real loneliness, artificial lovers, and why intimacy metrics will outlast DAUs.',
    date: '2025-09-28',
    tags: ['ai', 'intimacy'],
  },
  {
    ...
    excerpt: 'Voice systems and the craft of words that stay on the skin.',
    date: '2025-08-30',
...
const topics = [
  ...
  { label: 'AI & Belonging', hint: 'companionship, ethics, interfaces' },
]
    ...
    >
      <div className="flex items-end justify-between gap-6">
        <div className="max-w-3xl">
          <h2 id="journal-heading" className="text-3xl md:text-4xl font-semibold tracking-tight">
            Journal
          </h2>
      ...
      <article className="mt-10 rounded-2xl border p-6 md:p-8 card-hover transition">
        ...
        <h3 className="mt-3 text-2xl md:text-3xl font-semibold">
          <Link
            ...
            className="text-glow cursor-pointer inline-block transition-opacity opacity-95 hover:opacity-100"
          >
            {featured.title}
          </Link>
        </h3>

        <p className="mt-3 opacity-80 max-w-3xl">{featured.excerpt}</p>

        {readingMoments[featured.slug] && (
