...
const posts: Post[] = [
  ...
  },
  {
    ...
    excerpt:
      'Voice systems, narrative interfaces, and the craft of words that stay on the skin.',
    date: '2025-08-30',
...
export default function Journal() {
  ...
  return (
    ...
    >
      ...
      {/* Featured */}
      <article className="mt-10 rounded-2xl border p-6 md:p-8 hover:shadow-sm transition">
        ...
        <div className="mt-6">
          <Link href={`/journal/${featured.slug}`} className="inline-flex items-center rounded-md border px-4 py-2 text-sm hover:opacity-100 opacity-90">
            Read the essay
          </Link>
        </div>
      </article>
